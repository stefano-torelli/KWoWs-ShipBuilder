...
internal sealed class SourceBuilder(StringBuilder? sb = null)
{
    private const int IndentSize = 4;

    private readonly StringBuilder sb = sb ?? new StringBuilder();
    ...
    {
        this.AddBlankLineIfNeeded();
        this.AppendIndented(line).Append("(").AppendNewLine().IncreaseIndent().IncreaseIndent().DecreaseIndent();
